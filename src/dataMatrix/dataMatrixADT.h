...
#define MAXDEPTH 63  //max depth of a node
...
splitMatrix testTrainSplit(Matrix m, float splitPercentage, int seed);//create a new splitMatrix, which contains the test and training matrices
